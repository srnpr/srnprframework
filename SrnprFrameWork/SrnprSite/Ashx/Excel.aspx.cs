...
namespace SrnprSite.Ashx
{
    public partial class Excel : System.Web.UI.Page
    {
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            DataTableToExcelCVS(dt, DateTime.Now.ToString("yyyy_MM_dd_HH_mm_ss") + ".xls");
        }
        ...
        protected void DataTableToExcelCVS(DataTable dt, string sFileName)
        {
            ...
            for (int i = 0; i < iColumnLength; i++)
            {
                strList.Add(dt.Columns[i].ColumnName.Trim());
            ...
            for (int i = 0, j = dt.Rows.Count; i < j; i++)
            {
                ...
                for (int n = 0; n < iColumnLength; n++)
                {
                    strList.Add( dt.Rows[i][n].ToString().Trim().Replace("0","O").Replace("1","l"));
